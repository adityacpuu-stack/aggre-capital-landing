...
export default function PrivacyPolicy() {
  return (
    <PublicPage
      eyebrow="Privasi"
      title="Data Anda, kepercayaan Anda."
      description="Pelajari bagaimana informasi pribadi Anda dikumpulkan, digunakan, dan dilindungi."
                  ...
                  <Card>
                    <CardContent className="p-8">
                      ...
                      <div className="prose prose-lg max-w-none text-gray-700">
                        <p>
                          AGGRE CAPITAL ("kami", "kita", atau "perusahaan")
                          berkomitmen untuk melindungi privasi dan keamanan
                          informasi pribadi Anda. Kebijakan Privasi ini
                        ...
                        <p>
                          Dengan menggunakan layanan AGGRE CAPITAL, Anda
                      ...
                      <div className="space-y-4 text-gray-700">
                        ...
                        <ul className="space-y-3">
                          <li className="flex items-start">
                            ...
                            <div>
                              <strong>Penyediaan Layanan:</strong> Memproses
                              aplikasi pendanaan, verifikasi identitas, dan
                          ...
                          <li className="flex items-start">
                            ...
                            <div>
                              ...
                              update status, dan informasi penting terkait
                              layanan
                            </div>
                          </li>
                          <li className="flex items-start">
                            ...
                            <div>
                              ...
                              data untuk meningkatkan kualitas layanan dan
                              pengalaman pengguna
                            </div>
                          </li>
                          <li className="flex items-start">
                            <span className="text-teal-500 mr-3 mt-1">•</span>
                            <div>
                              <strong>Kepatuhan Hukum:</strong> Memenuhi
                ...
                <section id="berbagi" className="scroll-mt-24">
                  <Card>
                    <CardContent className="p-8">
                      ...
                      <div className="space-y-4 text-gray-700">
                        <p>
                          Kami tidak menjual, menyewakan, atau membagikan
                        ...
                        <ul className="space-y-3">
                          <li className="flex items-start">
                            <span className="text-teal-500 mr-3 mt-1">•</span>
                            <div>
                              <strong>Dengan Persetujuan Anda:</strong> Ketika
                              Anda secara eksplisit memberikan persetujuan untuk
                              berbagi informasi
                            </div>
                          </li>
                          <li className="flex items-start">
                            <span className="text-teal-500 mr-3 mt-1">•</span>
                            <div>
                              <strong>Penyedia Layanan:</strong> Dengan vendor
                              tepercaya yang membantu kami menyediakan layanan
                          ...
                          <li className="flex items-start">
                            <span className="text-teal-500 mr-3 mt-1">•</span>
                            <div>
                              <strong>Kewajiban Hukum:</strong> Ketika
                              diwajibkan oleh hukum atau untuk melindungi hak
                              dan keamanan kami
                            </div>
                          </li>
                        </ul>
                    ...
                    <CardContent className="p-8">
                      ...
                      <div className="space-y-4 text-gray-700">
                        <p>
                          ...
                          untuk melindungi informasi Anda:
                        </p>
                ...
                <section id="hak" className="scroll-mt-24">
                  <Card>
                    <CardContent className="p-8">
                      ...
                      <div className="space-y-4 text-gray-700">
                        <p>
                          Anda memiliki hak-hak berikut terkait informasi
                          pribadi Anda:
                        </p>
                        <div className="grid md:grid-cols-2 gap-6">
                          <div className="space-y-3">
                            <div className="flex items-start">
                              ...
                              <div>
                                ...
                                informasi pribadi yang kami miliki
                              </div>
                            </div>
                            <div className="flex items-start">
                              <span className="text-teal-500 mr-3 mt-1">•</span>
                              <div>
                                <strong>Koreksi:</strong> Meminta perbaikan
                          ...
                          <div className="space-y-3">
                            <div className="flex items-start">
                              <span className="text-teal-500 mr-3 mt-1">•</span>
                              <div>
                                <strong>Pembatasan:</strong> Membatasi
                            ...
                            <div className="flex items-start">
                              <span className="text-teal-500 mr-3 mt-1">•</span>
                              <div>
                                <strong>Portabilitas:</strong> Meminta transfer
                                data ke layanan lain
                              </div>
                            </div>
                            <div className="flex items-start">
                              <span className="text-teal-500 mr-3 mt-1">•</span>
                              <div>
                                <strong>Keberatan:</strong> Menolak pemrosesan
                    ...
                    <CardContent className="p-8">
                      ...
                      <div className="space-y-4 text-gray-700">
                        <p>
                          ...
                          waktu ke waktu. Perubahan material akan
                        ...
                        <ul className="space-y-2">
                          ...
                          <li className="flex items-start">
                            <span className="text-teal-500 mr-2">•</span>
                            <span>
                              Update tanggal "Terakhir diperbarui" di halaman
                              ini
                            </span>
                          </li>
                        </ul>
                        <p>
                          Penggunaan berkelanjutan layanan kami setelah
                    ...
                    <CardContent className="p-8">
                      ...
                      <div className="space-y-6">
                        <p className="text-gray-700">
                          ...
                          Privasi ini atau ingin menggunakan hak-hak Anda,
