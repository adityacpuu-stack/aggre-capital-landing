...
export default function Sitemap() {
  const siteStructure = [
    {
      ...
      href: "/",
      description:
        "Halaman utama dengan informasi lengkap tentang AGGRE CAPITAL",
      pages: [
    ...
    },
    {
      ...
      pages: [{ name: "Form Pengajuan", href: "/pengajuan" }],
    },
    {
      title: "Tentang Kami",
      icon: Building2,
    ...
    },
    {
      ...
      pages: [
        ...
        {
          name: "Testimoni Modal Usaha",
          href: "/testimoni?category=modal-usaha",
        },
        { name: "Testimoni Renovasi", href: "/testimoni?category=renovasi" },
        {
          name: "Testimoni Pendidikan",
          href: "/testimoni?category=pendidikan",
        },
      ],
    },
    {
  ...
  const legalPages = [
    ...
    },
    {
      ...
      href: "/cookies",
      description: "Penggunaan cookie di website",
    },
  ...
  return (
    <PublicPage
      ...
      description="Seluruh halaman AGGRE CAPITAL, tersusun dalam satu tempat."
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
                {[
                  ...
                  >
                    ...
                    <span className="text-gray-700 group-hover:text-teal-800 font-medium">
                      {link.name}
                    </span>
                  </Link>
                ))}
            ...
            <section className="bg-gray-50 rounded-lg p-8">
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-6">
                  Jika Anda tidak dapat menemukan halaman yang Anda cari,
