...
export default function CookiePolicy() {
  ...
  return (
    <PublicPage
      eyebrow="Cookie"
      title="Pilihan privasi di tangan Anda."
      description="Kenali penggunaan cookie dan kelola preferensi Anda."
                    ...
                    <CardContent className="p-8">
                      ...
                      <div className="prose prose-lg max-w-none text-gray-700">
                        <p>
                          ...
                          perangkat Anda ketika Anda mengunjungi website. Cookie
                          membantu website mengingat informasi tentang kunjungan
                          Anda, seperti preferensi bahasa dan pengaturan
                          lainnya.
                        </p>
                        <p>
                          AGGRE CAPITAL menggunakan cookie untuk meningkatkan
                          pengalaman pengguna, menganalisis penggunaan website,
                          dan menyediakan layanan yang lebih baik.
                        </p>
                          ...
                          <div className="flex items-start">
                            ...
                            <div>
                              ...
                              <p className="text-blue-700 text-sm">
                                Cookie tidak dapat merusak komputer Anda atau
                                membawa virus. Mereka hanya menyimpan informasi
                                yang Anda berikan kepada website.
                              </p>
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="space-y-6">
                        ...
                        <div className="border border-gray-200 rounded-lg p-6">
                          ...
                          <p className="text-gray-700 mb-3">
                            Cookie ini diperlukan untuk fungsi dasar website dan
                          ...
                          <ul className="space-y-1 text-sm text-gray-600">
                            ...
                            <li>
                              • Cookie untuk mengingat pengaturan keamanan
                            </li>
                          </ul>
                        </div>
                        ...
                        <div className="border border-gray-200 rounded-lg p-6">
                          ...
                          <p className="text-gray-700 mb-3">
                            Cookie ini meningkatkan fungsionalitas website dan
                            personalisasi.
                          </p>
                          <ul className="space-y-1 text-sm text-gray-600">
                            <li>
                              • Cookie untuk mengingat preferensi pengguna
                            </li>
                        ...
                        <div className="border border-gray-200 rounded-lg p-6">
                          ...
                          <p className="text-gray-700 mb-3">
                            Cookie ini membantu kami memahami bagaimana
                          ...
                          <ul className="space-y-1 text-sm text-gray-600">
                            ...
                            <li>
                              • Cookie untuk melacak halaman yang dikunjungi
                            </li>
                        ...
                        <div className="border border-gray-200 rounded-lg p-6">
                          ...
                          <p className="text-gray-700 mb-3">
                            Cookie ini digunakan untuk menampilkan iklan yang
                            relevan dan mengukur efektivitas kampanye.
                          </p>
                          <ul className="space-y-1 text-sm text-gray-600">
                          ...
                          <div>
                            ...
                            <ul className="space-y-2 text-gray-700">
                              <li className="flex items-start">
                                ...
                                <span>
                                  Memastikan website berfungsi dengan baik
                                </span>
                              </li>
                              <li className="flex items-start">
                                <CheckCircle className="h-4 w-4 text-green-500 mr-2 mt-1" />
                              ...
                              <li className="flex items-start">
                                <CheckCircle className="h-4 w-4 text-green-500 mr-2 mt-1" />
                                <span>
                                  Menganalisis penggunaan untuk perbaikan
                                </span>
                              </li>
                              <li className="flex items-start">
                                <CheckCircle className="h-4 w-4 text-green-500 mr-2 mt-1" />
                          ...
                          <div>
                            ...
                            <ul className="space-y-2 text-gray-700">
                              <li className="flex items-start">
                                ...
                                <span>
                                  <strong>Sesi:</strong> Hingga browser ditutup
                                </span>
                              </li>
                              <li className="flex items-start">
                                <span className="text-teal-500 mr-2">•</span>
                                <span>
                                  <strong>Persisten:</strong> 30 hari - 2 tahun
                                </span>
                              </li>
                              <li className="flex items-start">
                                <span className="text-teal-500 mr-2">•</span>
                                <span>
                                  <strong>Permanen:</strong> Hingga dihapus
                                  manual
                                </span>
                              </li>
                            </ul>
                  ...
                  <Card>
                    <CardContent className="p-8">
                      ...
                      <div className="space-y-4 text-gray-700">
                        <p>
                          Kami menggunakan layanan pihak ketiga yang dapat
                          menempatkan cookie di perangkat Anda. Berikut adalah
                          layanan yang kami gunakan:
                        </p>
                        <div className="space-y-4">
                          <div className="border border-gray-200 rounded-lg p-4">
                            ...
                            <p className="text-sm text-gray-600 mb-2">
                              Untuk menganalisis penggunaan website dan
                          ...
                          <div className="border border-gray-200 rounded-lg p-4">
                            ...
                            <p className="text-sm text-gray-600 mb-2">
                              Untuk menampilkan peta lokasi kantor dan cabang
                              kami.
                            </p>
                            <a
                              href="https://policies.google.com/privacy"
                          ...
                          <div className="border border-gray-200 rounded-lg p-4">
                            ...
                            <p className="text-xs text-gray-500">
                              Kebijakan privasi sesuai dengan platform
                              masing-masing
                            </p>
                          </div>
                        </div>
                    ...
                    <CardContent className="p-8">
                      ...
                      <div className="space-y-6">
                        <p className="text-gray-700">
                          Anda dapat mengatur preferensi cookie menggunakan
                          panel di bawah ini:
                        </p>
                              ...
                              <div className="flex items-center">
                                ...
                                <div>
                                  ...
                                  <p className="text-sm text-gray-600">
                                    Diperlukan untuk fungsi website
                                  </p>
                                </div>
                              </div>
                              <div className="flex items-center">
                          ...
                          <div className="flex items-start">
                            ...
                            <div>
                              ...
                              <p className="text-yellow-700 text-sm mt-1">
                                Anda juga dapat mengatur cookie melalui
                                pengaturan browser Anda. Namun, menonaktifkan
                                cookie tertentu dapat mempengaruhi
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                          <div className="space-y-3">
                            <div className="flex items-start">
                              ...
                              <div>
                                <strong>Mengatur Preferensi:</strong> Memilih
                                jenis cookie yang ingin Anda terima
                              </div>
                            </div>
                            <div className="flex items-start">
                              <CheckCircle className="h-5 w-5 text-green-500 mr-3 mt-1" />
                              <div>
                                <strong>Menghapus Cookie:</strong> Menghapus
                                cookie yang sudah tersimpan
                              </div>
                            </div>
                            <div className="flex items-start">
                              <CheckCircle className="h-5 w-5 text-green-500 mr-3 mt-1" />
                              <div>
                                <strong>Menolak Cookie:</strong> Menolak cookie
                                non-essential
                              </div>
                            </div>
                          </div>
                          <div className="space-y-3">
                            <div className="flex items-start">
                              <CheckCircle className="h-5 w-5 text-green-500 mr-3 mt-1" />
                              <div>
                                <strong>Informasi:</strong> Mendapatkan
                                informasi tentang cookie yang digunakan
                              </div>
                            </div>
                            <div className="flex items-start">
                              <CheckCircle className="h-5 w-5 text-green-500 mr-3 mt-1" />
                              <div>
                                <strong>Portabilitas:</strong> Meminta data yang
                                dikumpulkan melalui cookie
                              </div>
                            </div>
                            <div className="flex items-start">
                              <CheckCircle className="h-5 w-5 text-green-500 mr-3 mt-1" />
                              <div>
                                <strong>Keluhan:</strong> Mengajukan keluhan
                ...
                <section id="perubahan" className="scroll-mt-24">
                  <Card>
                    <CardContent className="p-8">
                      ...
                      <div className="space-y-4 text-gray-700">
                        <p>
                          Kami dapat memperbarui Kebijakan Cookie ini dari waktu
                          ke waktu. Perubahan akan dikomunikasikan melalui:
                        </p>
                        ...
                        <p>
                          Penggunaan berkelanjutan website kami setelah
                          perubahan dianggap sebagai persetujuan terhadap
                          kebijakan yang diperbarui.
                        </p>
                        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                          <p className="text-blue-800 text-sm">
                            <strong>Kontak:</strong> Jika Anda memiliki
                            pertanyaan tentang kebijakan cookie ini, silakan
                            hubungi kami di privacy@aggrecapital.com
                          </p>
                        </div>
                      </div>
                    </CardContent>
