    ...
    <div className="space-y-6">
      ...
      <Card className="admin-panel">
        <CardHeader className="admin-panel-heading">
          <CardTitle className="admin-panel-title flex items-center space-x-2">
              ...
              <tbody>
                {currentApplications.map((app, index) => (
                  ...
                  >
                    ...
                    <td className="py-3 px-4 text-gray-700">
                      Rp {parseInt(app.amount).toLocaleString("id-ID")}
                    </td>
                    ...
                    <td className="py-3 px-4">
                      <div className="flex space-x-2">
                        <Button
                          ...
                          onClick={() =>
                            router.push(`/pengajuan/${app.application_id}`)
                          }
                        >
                  ...
                  <tr>
                    <td colSpan={8}>
                      <div className="admin-empty">
                        ...
                        <p>Data pengajuan akan tampil setelah tersedia.</p>
                      </div>
                    </td>
                  </tr>
                )}
          ...
          {totalPages > 1 && (
            <div className="flex items-center justify-between mt-6 px-4">
              <div className="text-sm text-gray-700">
                ...
                {Math.min(endIndex, allApplications.length)} dari{" "}
                {allApplications.length} pengajuan
              </div>
