...
import { Plus, Star, Edit, Trash2, Save } from "lucide-react";
            ...
            <div>
              ...
              {testimonialFormData.image && (
                <div className="mt-2 text-xs text-gray-500">
                  💡 Tip: Gunakan foto dengan resolusi tinggi untuk hasil
                  terbaik
                </div>
              )}
            </div>
      ...
      <Card className="admin-panel">
        <CardHeader className="admin-panel-heading">
          <CardTitle className="admin-panel-title">
            Daftar Testimoni ({allTestimonials.length})
          </CardTitle>
        </CardHeader>
          ...
          {allTestimonials.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-600 mb-4">
                Mulai tambahkan testimoni dari customer untuk meningkatkan
                kredibilitas.
              </p>
              <Button
                onClick={() => setShowTestimonialForm(true)}
